...
def main():
    ...
    for optimizer in ['ADAM','SGDM','ADAGRAD']:
        print(optimizer)
        model, loss_func = train(trn_X, trn_Y, trn_vocab, optimizer)
        # save_model(model)
